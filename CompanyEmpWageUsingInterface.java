...
public class CompanyEmpWageUsingInterface {
	...
	public CompanyEmpWageUsingInterface(String company_name,int emp_rate_per_hour,int working_days,int max_hours_per_month){ 
